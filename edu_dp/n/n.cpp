...
// ref. https://atcoder.jp/contests/dp/submissions/3936122
...
int main(int argc, char** argv) {
  ...
  for (ll d = 2; d <= n; ++d) { // distance. d=r-l+1
    rep(l, n) {
      ll r = l+d-1;
      if (r >= n) { continue; } // invalid
      for (ll k = l; k < r; ++k) {
        chmin(dp[l][r], dp[l][k] + dp[k+1][r]);
      }
      dp[l][r] += s[r+1] - s[l]; // sum of [l, r]
    }
  }
  cout << dp[0][n-1] << endl;
}
