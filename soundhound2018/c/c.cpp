// ref. https://qiita.com/e869120/items/acba3dd8649d913102b5#101--150-%E5%95%8F%E7%9B%AE
...
const ll MAX_V = 1605;  // Maximum number of nodes in a graph.
const FLOW INF = 1e15;
    ...
    rep(c,w) {
      ...
      if ((r+c)%2 == 0) { // red
        ...
        rep(i,4) {
          ...
          if (mat[nextR][nextC] == '*') { continue; }
          g.addedge(r*w+c,nextR*w+nextC,1);
        }
      }
    }
  }
